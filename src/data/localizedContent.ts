...
const arabicContent = {
  ...
  faq: {
    ...
    pakistanAddress: 'الطابق الثاني، أمير تريد سنتر، بلوك 2، بي إي سي إتش إس، شارع الشهيد ملت، كراتشي، باكستان',
    SaudiEnglishAddress: 'شارع فراس بن حمد، حي الرويس، جدة 23214، منطقة مكة المكرمة، المملكة العربية السعودية',
    ...
    items: [
      ...
      },
      {
        ...
        answer: '<b>مكتب باكستان:</b> الطابق الثاني، أمير تريد سنتر، بلوك 2، بي إي سي إتش إس، شارع الشهيد ملت، كراتشي، باكستان\n\n<b>مكتب السعودية:</b> شارع فراس بن حمد، حي الرويس، جدة 23214، منطقة مكة المكرمة، المملكة العربية السعودية',
      },
    ],
  },
  about: {
