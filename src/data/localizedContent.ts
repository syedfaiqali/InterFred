...
const arabicContent = {
  ...
  faq: {
    ...
    SaudiEnglishAddress: 'أبو فراس الحمداني، الرويس، جدة 23214، المملكة العربية السعودية',
