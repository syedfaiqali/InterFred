...
const arabicContent = {
  ...
  faq: {
    ...
    globalPresence: [
      ...
      {
        country: 'مكتب الصين',
        address: 'مكتب 1201، المبنى 2، مركز BRETC للأعمال، رقم 10 طريق ووتشو، شارع دونغنان، تشانغشو، سوتشو، مقاطعة جيانغسو، الصين',
        code: 'CN'
      },
      {
        country: 'سنغافورة',
