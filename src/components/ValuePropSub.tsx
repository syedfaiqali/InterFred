  ...
  `}
        >
            ...
            >
                ...
                <p
                    className={`text-base leading-relaxed transition-all duration-500 ${hovered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                        } ${textColor}`}
                >
                    {text}
                </p>
...
const ValueProposition: React.FC = () => {
    ...
    return (
        <section className="bg-white px-10 pb-10" ref={sectionRef}>
                ...
                <div className="grid grid-cols-1 px-10 md:grid-cols-3 gap-y-14 md:gap-y-0">
                    ...
                    <div className="flex flex-col gap-14 justify-end">
                        <div className="relative top-[-10%] left-[-10%]">
                            <p className={`text-sm tracking-widest text-gray-400 mb-3 transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                                Why us
                            </p>
                            ...
                            <div className={`inline-block transition-all duration-700 delay-300 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                                <button className="bg-[#07119B] text-white px-8 py-4 text-sm tracking-wider font-semibold hover:bg-[#050D8A] transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl active:scale-95">
                                    Let’s discuss today!
                                </button>
                            </div>
                        </div>
